...
function( optix_setup_exports target export_file )
  ...
  if( NOT RELEASE_PUBLIC OR INTERNAL_DEVELOPER )
    first_time_message("adding developer symbols for ${target}")
    list( APPEND exported_symbols ${${target}_developer_symbols} ) 
  endif()
  if( RELEASE_PUBLIC_DEVELOPER_COMMERCIAL OR RELEASE_PUBLIC_COMMERCIAL OR INTERNAL_DEVELOPER)
    first_time_message("adding commercial symbols for ${target}")
    list( APPEND exported_symbols ${${target}_commercial_symbols} ) 
  endif()
  if( WIN32 )
...
# This is not needed at the moment, only when adding compute_XX automatically
...
# This adds compute_XX automatically, in order to generate PTX. We dont do this right now.
